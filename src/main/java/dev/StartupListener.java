...
public class StartupListener {
	...
	public void onStart() {
		...
		Nature nature = new Nature("Conseil", false, false, 10000, 0, 50000, false, LocalDate.of(2020, 5, 1),
				LocalDate.of(2021, 5, 1));
		this.natureRepo.save(nature);

		Nature nature2 = new Nature("Formation", false, false, 10000, 0, 50000, false, LocalDate.of(2020, 5, 1),
				LocalDate.of(2021, 5, 1));
		this.natureRepo.save(nature2);
		Nature nature3 = new Nature("Expertise_technique", false, false, 10000, 0, 50000, false,
